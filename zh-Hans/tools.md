...
房主在开设LMSR类型房间时，需要设定一个L值，L表示房主设定的亏损界值，房主提供的准备金F = L * ln（N），N为结果数量。例如，一个有4个选项的LMSR房间，L设为100000，则房主需要投入的准备金F为 100000  *  ln(4)，调出手机或电脑的科学计算器，ln(4)约等于1.386，此数字乘以10万即房主要投入的准备金F，约为13.86万。再例如，一个有24个选项的LMSR房间，L 设为10万，则ln(24)  *  100000 ，则房主要投入的准备金F约为 31.74万。（ln表示对数计算）
